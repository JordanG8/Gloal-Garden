...
import { IconInfo, IconGoogle } from '@/components/icons';
...
function GoogleButton() {
  ...
  return (
    <form action={googleSignInAction}>
      ...
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-2.5 rounded-full border border-line bg-card py-[13px] text-[15px] font-semibold text-ink transition hover:bg-chip active:scale-[0.985]"
      >
        <IconGoogle size={19} />
...
function OrDivider() {
  const { dict } = useI18n();
  return (
    <div className="flex items-center gap-3 py-1 text-[11px] font-semibold uppercase tracking-[0.1em] text-faint">
